...
async function getTutorStudents() {
    ...
    try {
        ...
        if (!data.success || data.students.length === 0) {
            tutorStudentContainer.innerHTML = "";
            noStudent.textContent = "You have no active students yet";
            return;
        }
        ...
        data.students.forEach(student => {
            ...
            const studentHTML = `
                <a href="student-preview.html?recipient-email=${encodeURIComponent(student.student_email)}&recipient-name=${encodeURIComponent(student.student_name)}&recipient-image=https://peerlynx-server.onrender.com${encodeURIComponent(student.profile_picture)}">
                    <div class="activeStudents">
